...
public class CsvReadingService {
    public static ArrayList<Client> readClients() {
        try {
            ...
            BufferedReader csvReader = new BufferedReader(new FileReader("./clients.csv"));
    ...
    public static Menu readRestaurantMenu(int restaurantId) {
        try {
            BufferedReader csvReader = new BufferedReader(new FileReader("./menus.csv"));
    ...
    public static ArrayList<Payload> readCartPayloads(int cartId) {
        try {
            ...
            BufferedReader csvReader = new BufferedReader(new FileReader("./payloads.csv"));
    ...
    public static ShoppingCart readOrderShoppingCart(int orderId) {
        try {
            BufferedReader csvReader = new BufferedReader(new FileReader("./shoppingCarts.csv"));
